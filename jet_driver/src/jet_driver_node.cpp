...
public:
  ...
  JetRobot(ros::NodeHandle nh)
  {
    ...
    encoder_left_sub = nh.subscribe<std_msgs::Int64>("/arduino/encoder_left_value", 10, &JetRobot::leftEncoderCB, this);
    encoder_right_sub = nh.subscribe<std_msgs::Int64>("/arduino/encoder_right_value", 10, &JetRobot::rightEncoderCB, this);
  ...
  void leftEncoderCB(const std_msgs::Int64::ConstPtr& val) {
    encoder_left = (double)val->data;
  }
  void rightEncoderCB(const std_msgs::Int64::ConstPtr& val) {
